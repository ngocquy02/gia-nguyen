 <div class="col-lg-3 col-md-3 col-ms-12 col-xs-12 pull-md-9 pull-lg-9">
        ...
        <ul class="p-0">
            ...
            @if($listCatLeft->count() > 0)
                @foreach($listCatLeft as $listCatLeft)
                    ...
                    <li>
                       <h3><a href="javascript:void(0)">{!!$listCatLeft->Name!!}<span class="fa fa-caret-right"></span></a></h3>
    ...
    <!-- Tin tức mới nhất -->
    @php 
        $news_1=App\Models\Article::orderBy('id','desc')->first();
        $news=App\Models\Article::orderBy('id','DESC')->get();
    @endphp
    <div class="clearfix"></div>
    <div class="hotline">
        <div class="header-hotline">
    ...
    <div class="hotline">
        ...
        <div class="list-hotline">
            <ul class="p-0">
                <a href="" title=""><img src="Upload/partner/dt-1.png" class="img-fluid partner-img" alt="Responsive image"></a>
            </ul>
        </div>
    </div>
    <!-- Xưởng sản xuất -->
