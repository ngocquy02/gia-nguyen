...
*/
// $config_url=$_SERVER["SERVER_NAME"].'/baseUrl';
// if ($_SESSION['login']['role']==1) {
	$baseUrl = '/upload/';
// }
// else
// {
// 	$baseUrl = '/upload/'.$_SESSION['login']['username']."/";
// }
...
$_SESSION['CKFinder_UserRole']=$_SESSION['login']['role'];
//session_start();
...
$config['AccessControl'][] = Array(
		...
		'folderView' => true,// Quyền xem forder
		'folderCreate' => true,// Quyền tạo forder
		'folderRename' => true,// Quyền đổi tên forder
		'folderDelete' => true,// Quyền xóa forder
...
$config['AccessControl'][] = Array(
		...
		'folderView' => true,// Quyền xem forder
		'folderCreate' => true,// Quyền tạo forder
		'folderRename' => false,// Quyền đổi tên forder
		'folderDelete' => false,// Quyền xóa forder

		'fileView' => true,// Quyền xem file
		'fileUpload' => true,// Quyền upload file
		'fileRename' => false,// Quyền đổi tên file
